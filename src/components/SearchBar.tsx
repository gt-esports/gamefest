  ...
  return (
    <div className="relative w-96 pl-20">
      <input
        type="text"
        placeholder="Search..."
        className="w-full p-4 border border-gray-300 rounded-lg bg-transparent font-bayon text-2xl"
        value={search}
        onChange={(e) => setSearch(e.target.value)}
      />
      {search && (
        <ul className="relative right-0 mt-2 bg-gray-500 border border-gray-500 rounded-lg shadow-lg">
